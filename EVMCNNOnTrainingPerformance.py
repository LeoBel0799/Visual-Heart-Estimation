...
# Test on train
model =  CNNBody()
model.load_state_dict(torch.load('/home/ubuntu/data/ecg-fitness_raw-v1.0/dlib/EVMCNN/EVMCNN_testrain_optuna.pt', map_location='cpu'))
model.to('cuda')
...
plt.savefig('/home/ubuntu/data/ecg-fitness_raw-v1.0/dlib/EVMCNN/scatterplot_EVMCNN_train.png')
plt.close()
...
plt.savefig('/home/ubuntu/data/ecg-fitness_raw-v1.0/dlib/EVMCNN/errorplot_EVMCNN_train.png')
plt.close()
...
# plt.legend()
# plt.xticks([])
# plt.savefig('/home/ubuntu/data/ecg-fitness_raw-v1.0/dlib/EVMCNN/true_vs_predicted_EVMCNN.png')
# plt.close()
...
plt.savefig('/home/ubuntu/data/ecg-fitness_raw-v1.0/dlib/EVMCNN/train_val_loss_EVMCNN.png')
plt.close()
...
plt.xlabel('Ground Truth')
plt.ylabel('Prediction')
plt.savefig('/home/ubuntu/data/ecg-fitness_raw-v1.0/dlib/EVMCNN/scatterplot_EVMCNN.png')
plt.close()
...
plt.xlabel('Image')
plt.ylabel('Prediction Error')
plt.savefig('/home/ubuntu/data/ecg-fitness_raw-v1.0/dlib/EVMCNN/errorplot_EVMCNN.png')
plt.close()
...
plt.savefig('/home/ubuntu/data/ecg-fitness_raw-v1.0/dlib/EVMCNN/rmse_val_plot_EVMCNN.png')
plt.close()
