...
def objective(trial, train, val):
    ...
    for epoch in range(num_epochs):
        ...
        for batch_idx, batch in tqdm(enumerate(training_loader, 1), total=len(training_loader),
...
study.optimize(lambda trial: objective(trial, training_loader, validation_loader), n_trials=30)
...
torch.save(model.state_dict(),'/home/ubuntu/data/ecg-fitness_raw-v1.0/dlib/DEEPPHYS/IndividuiSeparati/DeepPhys.pt')

###############################################################################
# Test on train
model =  DeepPhys()
model.load_state_dict(torch.load('/home/ubuntu/data/ecg-fitness_raw-v1.0/dlib/DEEPPHYS/IndividuiSeparati/DeepPhys.pt', map_location='cpu'))
model.to('cuda')
...
plt.savefig('/home/ubuntu/data/ecg-fitness_raw-v1.0/dlib/DEEPPHYS/IndividuiSeparati/scatterplot_DeepPhys_train.png')
plt.close()
...
plt.savefig('/home/ubuntu/data/ecg-fitness_raw-v1.0/dlib/DEEPPHYS/IndividuiSeparati/errorplot_DeepPhys_train.png')
plt.close()
...
with open("/home/ubuntu/data/ecg-fitness_raw-v1.0/dlib/DEEPPHYS/IndividuiSeparati/output.txt", "w") as file:
...
plt.savefig('/home/ubuntu/data/ecg-fitness_raw-v1.0/dlib/DEEPPHYS/IndividuiSeparati/train_val_loss_DeepPhys.png')
plt.close()
...
plt.xlabel('Ground Truth')
plt.ylabel('Prediction')
plt.savefig('/home/ubuntu/data/ecg-fitness_raw-v1.0/dlib/DEEPPHYS/IndividuiSeparati/scatterplot_DeepPhys.png')
plt.close()
...
plt.xlabel('Image')
plt.ylabel('Prediction Error')
plt.savefig('/home/ubuntu/data/ecg-fitness_raw-v1.0/dlib/DEEPPHYS/IndividuiSeparati/errorplot_DeepPhys.png')
plt.close()
...
plt.savefig('/home/ubuntu/data/ecg-fitness_raw-v1.0/dlib/DEEPPHYS/IndividuiSeparati/rmse_val_plot_DeepPhys.png')
plt.close()
