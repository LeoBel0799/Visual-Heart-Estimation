...
torch.save(model.state_dict(),'/home/ubuntu/data/ecg-fitness_raw-v1.0/dlib/DEEP/Separati/DeepPhys_sep.pt')
...
model = DeepPhys()
model.load_state_dict(torch.load('/home/ubuntu/data/ecg-fitness_raw-v1.0/dlib/DEEP/Separati/DeepPhys_sep.pt', map_location='cpu'))
model.to('cuda')
...
plt.savefig('/home/ubuntu/data/ecg-fitness_raw-v1.0/dlib/DEEP/Separati/scatterplot_train_deep.png', dpi=300, bbox_inches='tight')
plt.close()
...
plt.savefig('/home/ubuntu/data/ecg-fitness_raw-v1.0/dlib/DEEP/Separati/errorplot_train_deep.png', dpi=300, bbox_inches='tight')
plt.close()
...
with open("/home/ubuntu/data/ecg-fitness_raw-v1.0/dlib/DEEP/Separati/output.txt", "w") as file:
...
plt.legend(fontsize=12)
plt.xticks([])
plt.savefig('/home/ubuntu/data/ecg-fitness_raw-v1.0/dlib/DEEP/Separati/true_vs_predicted_deep.png', dpi=300, bbox_inches='tight')
plt.close()
...
plt.ylabel('Prediction', fontsize=14)
plt.legend(fontsize=12)
plt.savefig('/home/ubuntu/data/ecg-fitness_raw-v1.0/dlib/DEEP/Separati/scatterplot_deep.png', dpi=300, bbox_inches='tight')
plt.close()
...
plt.xlabel('Image', fontsize=14)
plt.ylabel('Prediction Error', fontsize=14)
plt.savefig('/home/ubuntu/data/ecg-fitness_raw-v1.0/dlib/DEEP/Separati/errorplot_deep.png', dpi=300, bbox_inches='tight')
plt.close()
...
plt.savefig('/home/ubuntu/data/ecg-fitness_raw-v1.0/dlib/DEEP/Separati/mean_rmse_train_val_loss_deep.png')
plt.close()
