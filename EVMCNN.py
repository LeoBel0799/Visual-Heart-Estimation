...
torch.save(model.state_dict(),'/home/ubuntu/data/ecg-fitness_raw-v1.0/dlib/EVM/EVM.pt')
...
model = CNNBody()
model.load_state_dict(torch.load('/home/ubuntu/data/ecg-fitness_raw-v1.0/dlib/EVM/EVM.pt', map_location='cpu'))
model.to('cuda')
...
plt.savefig('/home/ubuntu/data/ecg-fitness_raw-v1.0/dlib/EVM/scatterplot_train_evm.png', dpi=300, bbox_inches='tight')
plt.close()
...
plt.savefig('/home/ubuntu/data/ecg-fitness_raw-v1.0/dlib/EVM/errorplot_train_evm.png', dpi=300, bbox_inches='tight')
plt.close()
...
with open("/home/ubuntu/data/ecg-fitness_raw-v1.0/dlib/EVM/output_test.txt", "w") as file:
    file.write(f"\nGround Truth: {train_denormalized_values_list_target}\n")
    file.write(f"Prediction: {train_denormalized_values_list_pred}\n")
...
plt.legend(fontsize=12)
plt.xticks([])
plt.savefig('/home/ubuntu/data/ecg-fitness_raw-v1.0/dlib/EVM/true_vs_predicted_evm.png', dpi=300, bbox_inches='tight')
plt.close()
...
plt.ylabel('Prediction', fontsize=14)
plt.legend(fontsize=12)
plt.savefig('/home/ubuntu/data/ecg-fitness_raw-v1.0/dlib/EVM/scatterplot_evm.png', dpi=300, bbox_inches='tight')
plt.close()
...
plt.xlabel('Image', fontsize=14)
plt.ylabel('Prediction Error', fontsize=14)
plt.savefig('/home/ubuntu/data/ecg-fitness_raw-v1.0/dlib/EVM/errorplot_evm.png', dpi=300, bbox_inches='tight')
plt.close()
...
plt.savefig('/home/ubuntu/data/ecg-fitness_raw-v1.0/dlib/EVM/rmse_val_plot_evm.png', dpi=300, bbox_inches='tight')
plt.close()
...
plt.savefig('/home/ubuntu/data/ecg-fitness_raw-v1.0/dlib/EVM/mean_rmse_train_val_loss_evm.png')
plt.close()