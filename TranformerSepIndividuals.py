...
def objective(trial, train, val):
    ...
    for epoch in range(N_EPOCHS):
        ...
        for batch in tqdm(training_loader, desc=f'Epoch {epoch + 1}/{N_EPOCHS}'):
...
study.optimize(lambda trial: objective(trial, training_loader, validation_loader), n_trials=10)
...
torch.save(best_model.state_dict(),'/home/ubuntu/data/ecg-fitness_raw-v1.0/dlib/VIT/IndividuiSeparati/VIT.pt')

###############################################################################
# Test on train
model =  MyViT((3,40,40), n_patches=best_patch_size, n_blocks=best_nblock, hidden_d=best_hidden,  n_heads=best_heads)
model.load_state_dict(torch.load('/home/ubuntu/data/ecg-fitness_raw-v1.0/dlib/VIT/IndividuiSeparati/VIT.pt', map_location='cpu'))
model.to('cuda')
...
plt.savefig('/home/ubuntu/data/ecg-fitness_raw-v1.0/dlib/VIT/IndividuiSeparati/scatterplot_VIT_train.png')
plt.close()
...
plt.savefig('/home/ubuntu/data/ecg-fitness_raw-v1.0/dlib/VIT/IndividuiSeparati/errorplot_VIT_train.png')
plt.close()
...
plt.legend()
plt.xticks([])
plt.savefig('/home/ubuntu/data/ecg-fitness_raw-v1.0/dlib/VIT/IndividuiSeparati/true_vs_predicted_VIT.png')
plt.close()
...
plt.savefig('/home/ubuntu/data/ecg-fitness_raw-v1.0/dlib/VIT/IndividuiSeparati/train_val_loss_VIT.png')
plt.close()
...
plt.xlabel('Ground Truth')
plt.ylabel('Prediction')
plt.savefig('/home/ubuntu/data/ecg-fitness_raw-v1.0/dlib/VIT/IndividuiSeparati/scatterplot_VIT.png')
plt.close()
...
plt.xlabel('Image')
plt.ylabel('Prediction Error')
plt.savefig('/home/ubuntu/data/ecg-fitness_raw-v1.0/dlib/VIT/IndividuiSeparati/errorplot_VIT.png')
plt.close()
...
plt.savefig('/home/ubuntu/data/ecg-fitness_raw-v1.0/dlib/VIT/IndividuiSeparati/rmse_val_plot_VIT.png')
plt.close()
